...
exports.rule = {
    meta: {
        ...
        messages: {
            ...
            suggestLexicographicOrder: 'Add a comparator function to sort in ascending lexicographic order',
    ...
    create(context) {
        ...
        return {
            'CallExpression[arguments.length=0][callee.type="MemberExpression"]': (call) => {
                ...
                if (helpers_1.sortLike.includes(text) && (0, helpers_1.isArrayLikeType)(type, services)) {
