...
*/
public class ExternalCandiateAddedToSystemSendEmailCommand {
	...
	*/
	public ExternalCandiateAddedToSystemSendEmailCommand(ExternalCandiateMessageSendEmailCommandBuilder builder) {
	...
	*/
	public static class ExternalCandiateMessageSendEmailCommandBuilder{
		...
		*/
		public ExternalCandiateAddedToSystemSendEmailCommand build() {
			return new ExternalCandiateAddedToSystemSendEmailCommand(this);
		}
