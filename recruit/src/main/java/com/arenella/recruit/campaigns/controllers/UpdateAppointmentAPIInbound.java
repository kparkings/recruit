...
*/
@JsonDeserialize(builder=UpdateAppointmentAPIInbound.AddAppointmentAPIInboundBuilder.class)
public class UpdateAppointmentAPIInbound {
	...
	*/
	public UpdateAppointmentAPIInbound(AddAppointmentAPIInboundBuilder builder) {
	...
	*/
	...
	public static class AddAppointmentAPIInboundBuilder {
		...
		*/
		public UpdateAppointmentAPIInbound build() {
			return new UpdateAppointmentAPIInbound(this);
		}
