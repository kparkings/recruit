...
public class ExternalCandiateDataRetentionRenewalSendEmailCommand {
	...
	*/
	public ExternalCandiateDataRetentionRenewalSendEmailCommand(ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder builder) {
	...
	* @return Builder
	*/
	public static ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder builder() {
		return new ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder();
	}
	
	/**
	* Builder for the Class 
	*/
	public static class ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder{
		...
		* @return Builder
		*/
		public ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder recipients(Set<EmailRecipient<UUID>> recipients) {
		...
		* @return Builder
		*/
		public ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder message(String message) {
		...
		* @return Builder
		*/
		public ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder recruiterName(String recruiterName) {
		...
		* @return Builder
		*/
		public ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder recruiterCompany(String recruiterCompany) {
		...
		* @return Builder
		*/
		public ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder recruiterEmail(String recruiterEmail) {
		...
		* @return
		*/
		public ExternalCandiateDataRetentionRenewalSendEmailCommandBuilder campaignOrRole(String campaignOrRole) {
		...
		*/
		public ExternalCandiateDataRetentionRenewalSendEmailCommand build() {
			return new ExternalCandiateDataRetentionRenewalSendEmailCommand(this);
		}
