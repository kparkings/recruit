...
public class CategoryExtractorUtil{
	...
	public static final ListingCategory itSecurity			= new ListingCategory(Listing.TECH.SECURITY, 			Set.of("security engineer", "ethical hacker", "security officer", "security consultant", "security specialist", "security engineering", "security lead", "cyber consultant", "security advisor", "security manager", "security operations", " soc "));
