	...
	public static RecruiterProfileEntity convertToEntity(RecruiterProfile recruiterProfile) {
		return RecruiterProfileEntity
				.builder()
					...
					.photoBytes(recruiterProfile.getProfilePhoto().isPresent() ? recruiterProfile.getProfilePhoto().get().getImageBytes() : null)
					.photoFormat(recruiterProfile.getProfilePhoto().isPresent() ?recruiterProfile.getProfilePhoto().get().getFormat() : null)
