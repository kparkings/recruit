...
public class CandidateStandardAPIOutbound implements CandidateAPIOutbound{
	...
	*/
	public static class CandidateAPIOutboundBuilder {
		...
		*/
		public CandidateStandardAPIOutbound build() {
			return new CandidateStandardAPIOutbound(this);
		}
	}
	...
	*/
	public static CandidateStandardAPIOutbound convertFromCandidate(Candidate candidate) {
		
		return CandidateStandardAPIOutbound
				.builder()
