...
public class CountryExtractor implements JobSpecifcationFilterExtractor{
	...
	public static final Set<String> CITIES_UK 					= Set.of("northampton ","warwick","sunderland","nottingham"," reading."," reading,", " reading ","london","birmingham","glasgow","manchester","sheffield","leeds","edinburgh","liverpool","bristol","cardiff","leicester","bradford");
	public static final Set<String> CITIES_NETHERLANDS 			= Set.of("hengelo","maastricht","almelo","alkmaar", "alphen", "amsterdam","rotterdam","the hague","den haag","Utrecht","Groningen","eindhoven","tilburg","almere","breda","nijmegen","enschede","haarlem", "amstelveen", "woerden", "amersfoort", "soest","arnhem","nieuwegein","zwolle","apeldoorn", "utrecht");
