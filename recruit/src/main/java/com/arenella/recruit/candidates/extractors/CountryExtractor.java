...
public class CountryExtractor implements JobSpecifcationFilterExtractor{
	...
	public static final Set<String> NORTHERN_IRELAND 	= Set.of("country armagh","country antrim","country down","newry","lisburn","bangor","londonderry","newtownabbey","craigavon","derry","belfast","northern irealnd");
	...
	public static final Set<String> POLAND 				= Set.of("Praca", "pln", "pologne","polonia","polen","poland","warsaw","wrocław","kraków","łódź","poznań","gdańsk","szczecin","bydgoszcz","lublin","białystok");
	...
	public static final Set<String> PORTUGAL 			= Set.of("portogallo","le portugal","portugal", "lisbon");
	...
	public static final Set<String> SWITZERLAND 		= Set.of("zwitserland","svizzera","suisse","suiza","Schweiz","zwitzerland", "zurich", "geneva", " bern ","bern.", "lucerne", "basel", "lausanne", "winterthur", "st. gallen", "lugano","biel", "bienne", "fribourg", "freiburg");
