...
public class ContractTypeExtractor implements JobSpecifcationFilterExtractor{
	...
	final Set<String> contract 	= Set.of("contract role","contract opportunity","months contract"," maanden","monate", "cdd"," p.u"," p/u"," p/d","detachering", "verlenging", "euros/day","daily rate","b2b","optie tot verlenging","6 month", "3 month", "interim", "ir35","freelance", "per hour", "per uur", "uurtarief", "hourly rate", "day rate","month contract","per day", "payroll constructie");
