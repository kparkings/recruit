...
/**
* Outbound API representation of a CandidateSearchAlert
* @author K Parkings
*/
public class CandidateSearchAlertAPIOutbound {
	...
	*/
	public CandidateSearchAlertAPIOutbound(CandidateSearchAlertAPIOutboundBuilder builder) {
	...
	*/
	...
	/**
	* Returns a Builder for the CandidateSearchAlertAPIOutbound class
	* @return Builder
	*/
	public static CandidateSearchAlertAPIOutboundBuilder builder() {
		return new CandidateSearchAlertAPIOutboundBuilder();
	}
	
	/**
	* Builder for the CandidateSearchAlertAPIOutbound class
	* @author K Parkings
	*/
	public static class CandidateSearchAlertAPIOutboundBuilder{
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder alertId(UUID alertId) {
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder alertName(String alertName) {
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder countries(Set<COUNTRY> countries) {
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder functions(Set<FUNCTION> functions) {
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder freelance(Optional<Boolean> freelance) {
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder perm (Optional<Boolean> perm) {
			this.perm = perm;
			return this;
		}
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder yearsExperienceGtEq (int yearsExperienceGtEq) {
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder yearsExperienceLtEq(int yearsExperienceLtEq) {
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder dutch(Language.LEVEL dutch) {
			this.dutch = dutch;
			return this;
		}
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder english(Language.LEVEL english) {
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder french(Language.LEVEL french) {
			this.french = french;
			return this;
		}
		...
		* @return Builder
		*/
		public CandidateSearchAlertAPIOutboundBuilder skills(Set<String> skills) {
			this.skills.clear();
		...
		*/
		public CandidateSearchAlertAPIOutbound build() {
			return new CandidateSearchAlertAPIOutbound(this);
		}
		
	}
	
	/**
	* Converts from Domain representation to API outbound representation
	* @param domain
	* @return
	*/
	public static CandidateSearchAlertAPIOutbound convertFromDomain(CandidateSearchAlert domain) {
		return CandidateSearchAlertAPIOutbound
				.builder()
					.alertId(domain.getAlertId())
					.alertName(domain.getAlertName())
					.countries(domain.getCountries())
					.dutch(domain.getDutch())
					.english(domain.getEnglish())
					.freelance(domain.getFreelance())
					.french(domain.getFrench())
					.functions(domain.getFunctions())
					.perm(domain.getPerm())
					.skills(domain.getSkills())
					.yearsExperienceGtEq(domain.getYearsExperienceGtEq())
					.yearsExperienceLtEq(domain.getyearsExperienceLtEq())
				.build();
	}
