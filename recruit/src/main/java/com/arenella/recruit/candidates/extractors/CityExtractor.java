...
public class CityExtractor implements JobSpecifcationFilterExtractor{
	...
	public static final Set<String> CITIES_FRANCE 				= Set.of("lilloise","île-de-france","paris","marseille","lyon","toulouse","nantes","marne","strasbourg","bordeaux","montpellier","rouen","lille");
