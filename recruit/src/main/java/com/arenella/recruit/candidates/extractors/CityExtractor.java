...
public class CityExtractor implements JobSpecifcationFilterExtractor{
	...
	public static final Set<String> CITIES_UK 					= Set.of("burnley","sunderland","norfolk","nottingham","newcastle","oxford", " reading."," reading,", " reading ","london","birmingham","glasgow","manchester","sheffield","leeds","edinburgh","liverpool","bristol","cardiff","leicester","bradford");
