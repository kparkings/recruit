...
public class CityExtractor implements JobSpecifcationFilterExtractor{
	...
	public static final Set<String> CITIES_UK 					= Set.of("woking","bournemouth","lancaster","warrington","watford","swindon"," bath ","lincoln","northampton ","warwick", " derby ","burnley","sunderland","norfolk","nottingham","newcastle","oxford", " reading."," reading,", " reading ","london","birmingham","glasgow","manchester","sheffield","leeds","edinburgh","liverpool","bristol","cardiff","leicester","bradford");
	public static final Set<String> CITIES_NETHERLANDS 			= Set.of("gelderland","limburg","hilversum","hengelo","zeist","maastricht","almelo"," leiden ", "alkmaar", "alphen", "amsterdam","rotterdam","the hague","den haag","utrecht","groningen","eindhoven","tilburg","almere","breda","nijmegen","enschede","haarlem", "amstelveen", "woerden", "amersfoort", "soest","arnhem","nieuwegein","zwolle","apeldoorn");
	...
	public static final Set<String> CITIES_FRANCE 				= Set.of("lilloise","île-de-france","paris","marseille","lyon","toulouse","nantes ","nantes.","marne","strasbourg","bordeaux","montpellier","rouen","lille");
	...
	public static final Set<String> CITIES_SWITZERLAND 			= Set.of(" bern "," bern.","fribourg","st. gallen","zurich","geneva","basel","lausanne","winterthur","lucerne","saint gallen","lugano"," biel "," bienne ","thun ","bellinzona");
