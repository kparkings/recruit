...
public class CityExtractor implements JobSpecifcationFilterExtractor{
	...
	public static final Set<String> CITIES_UK 					= Set.of("nottingham","newcastle","oxford", " reading."," reading,", " reading ","london","birmingham","glasgow","manchester","sheffield","leeds","edinburgh","liverpool","bristol","cardiff","leicester","bradford");
	public static final Set<String> CITIES_NETHERLANDS 			= Set.of("maastricht","almelo"," leiden ", "alkmaar", "alphen", "amsterdam","rotterdam","the hague","den haag","Utrecht","Groningen","eindhoven","tilburg","almere","breda","nijmegen","enschede","haarlem", "amstelveen", "woerden", "amersfoort", "soest","arnhem","nieuwegein","zwolle","apeldoorn", "utrecht");
