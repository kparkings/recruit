...
export class CandidateServiceService {
	...
	*/
	public getCandidateSuggestions(searchRequest:SuggestionsSearchRequest): Observable<any>{
		...
		const backendUrl:string = environment.backendUrl +'submitCandidateSearchRequest/?page=0&unfiltered=true&size=112&backendRequestId=1&searchText=&available=true';
